...
var SelectComponent = (function () {
    ...
    SelectComponent.prototype.ngOnInit = function () {
        ...
        setTimeout(function () { document.addEventListener('click', _this.clickedOutside); });
    };
    ...
    SelectComponent.prototype.scrollToSelected = function () {
...
var Behavior = (function () {
    ...
    Behavior.prototype.ensureHighlightVisible = function (optionsMap) {
        ...
        var searchInput = this.actor.element.nativeElement.querySelector('.ui-select-search');
        if (searchInput) {
